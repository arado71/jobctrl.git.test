namespace Tct.ActivityRecorderClient.View
{
	partial class ModifyWorkForm
	{
		...
		private void InitializeComponent()
		{
			...
			// dtpLocalStart
			// 
			this.dtpLocalStart.CustomFormat = "yyyy-MM-dd hh:mm:ss";
			...
			this.dtpLocalStart.TabIndex = 2;
			this.dtpLocalStart.ValueChanged += new System.EventHandler(this.HandleDateChanged);
			// 
			// dtpLocalEnd
			// 
			this.dtpLocalEnd.CustomFormat = "yyyy-MM-dd hh:mm:ss";
			...
			this.rbModify.Checked = true;
			this.rbModify.Location = new System.Drawing.Point(3, 3);
			...
			this.rbDelete.Location = new System.Drawing.Point(65, 3);
			...
			this.Name = "ModifyWorkForm";
			this.Text = "Modify work";
