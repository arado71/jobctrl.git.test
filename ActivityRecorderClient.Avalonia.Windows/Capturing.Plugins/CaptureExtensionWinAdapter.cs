...
{
	public class CaptureExtensionWinAdapter : ICaptureExtensionAdapter
	{
		...
		public CaptureExtensionWinAdapter(Func<PluginStartInfoDetails, ICaptureExtension> extensionFactory, PluginStartInfo settings)
		{
