...
namespace AppControlService
{
    ...
    /// 
    /// Based on:
	/// https://social.msdn.microsoft.com/Forums/windowsdesktop/en-US/31bfa13d-982b-4b1a-bff3-2761ade5214f/calling-createprocessasuser-from-service
	///
	/// </summary>
    public class ApplicationLoader
    {
	    ...
	    /// <returns></returns>
	    public static bool StartProcessAndBypassUAC(String applicationName, out PROCESS_INFORMATION procInfo, uint sourcePid = 0)
        {
		    ...
		    if (!DuplicateToken(sourcePid, out sa, ref hUserTokenDup)) return false;

		    var result = CreateProcessAsUser(applicationName, hUserTokenDup, sa, ref procInfo);
	    ...
	    public static bool CreateProcessAsUser(string applicationName, IntPtr hUserTokenDup, SECURITY_ATTRIBUTES sa,
	    ...
	    public static bool DuplicateToken(uint sourcePid, out SECURITY_ATTRIBUTES sa, ref IntPtr hUserTokenDup)
	    {
		    ...
		    hProcess = OpenProcess(MAXIMUM_ALLOWED, false, sourcePid);
