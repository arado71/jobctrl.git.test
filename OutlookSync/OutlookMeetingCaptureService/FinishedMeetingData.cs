...
namespace OutlookMeetingCaptureService
{
	...
	public partial class FinishedMeetingEntry
	{
		...
		public override string ToString()
		{
			...
			return String.Format("[Status = {8}, Title = {3}, Location = {4}, StartTime = {5}, EndTime = {6}, CreationTime = {1}, LastModificationTime = {2}, Attendees = {7}, OldStart = {9}, Id = {0}]", Id, CreationTime, LastmodificationTime, Title, Location, StartTime, EndTime, attendeesStr, Status, OldStartTime);
		}
	}
