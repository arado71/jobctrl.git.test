...
var Gmail_ = function(localJQuery) {
    ...
    */
    ...
    api.tracker.globals   = typeof GLOBALS !== "undefined"
        ? GLOBALS
        : (
            typeof(window) !== "undefined" && window.opener != null && typeof window.opener.GLOBALS !== "undefined" // custom fix: check window.opener with != instead of !==
    ...
    api.tracker.view_data = typeof VIEW_DATA !== "undefined"
        ? VIEW_DATA
        : (
            typeof(window) !== "undefined" && window.opener != null && typeof window.opener.VIEW_DATA !== "undefined" // custom fix: check window.opener with != instead of !==
