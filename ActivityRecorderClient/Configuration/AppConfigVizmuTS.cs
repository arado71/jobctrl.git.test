...
{
#if AppConfigVizmuTS || DEBUG

	public class AppConfigVizmuTS : AppConfig
	{
		...
		public override string AppClassifier => "FVMTS";
		...
		public override bool DisableManualStatusChange => true;
		...
		public override string AppNameOverride => "Timesheet";
		public override string CalendarFolderInclusionPattern => @"^[\\][\\]([a-zA-Z0-9._%+-]+@(([0-9a-zA-Z][-\w]*[0-9a-zA-Z]*\.)+[a-zA-Z0-9]{2,17}))|(Postaláda [^\\]*)|(Postafiók [^\\]*)[\\](Naptár|Calendar)$";
	}
