...
{
#if AppConfigSandbox || DEBUG

	public class AppConfigSandbox : AppConfig
	{
		protected override EndpointAddress ServiceNetTcpEndpointAddress => new EndpointAddress(
			new Uri("net.tcp://217.79.135.22:9010/ActivityRecorderService", UriKind.Absolute),
		...
		public override string WebsiteUrl => "http://sandbox.jobctrl.com/";
		...
		public override string AppClassifier => "Sandbox";
