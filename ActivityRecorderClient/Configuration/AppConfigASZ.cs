...
{
#if AppConfigASZ || DEBUG

	public class AppConfigASZ : AppConfig
	{
		protected override EndpointAddress ServiceNetTcpEndpointAddress => new EndpointAddress(
			new Uri("net.tcp://jobctrl.asz.hu:9000/ActivityRecorderService", UriKind.Absolute),
		...
		protected override EndpointAddress ServiceHttpsEndpointAddress => new EndpointAddress(
			new Uri("https://jobctrl.asz.hu/JobCTRL/", UriKind.Absolute)
		);
		...
		public override string WebsiteUrl => "https://jobctrl.asz.hu/";
		public override string AppClassifier => "ÁSZ";
		...
		public override bool IsLoginRememberPasswordChecked => true;
	}
