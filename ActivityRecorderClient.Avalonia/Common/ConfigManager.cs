...
namespace Tct.ActivityRecorderClient
{
	public class ConfigManager
	{
		...
		public static async Task<bool> EnsureLoggedInAsync(Func<Task<LoginData>> loginDataFactory)
		{
			if (ConfigManager.UserId != ConfigManager.LoggedOutUserId) return true;
			Debug.Assert(loginDataFactory != null);
			var loginData = await loginDataFactory();
			return SetLoginData(loginData, false);
...
// TODO: mac
namespace Tct.ActivityRecorderClient.View.WorkDetectorRuleEditForm
{
