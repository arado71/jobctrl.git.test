...
namespace Tct.ActivityRecorderClient.Capturing.Extra
{
	public class WorkTimeStatsFromWebsiteManager : IDisposable
	{
		...
		public void GetWorkTimeStatsFromServer(Action<WorkTimeStats> onSuccessCallback, Action<TimeSpan> onErrorCallback)
		{
		...
		public WorkTimeStats GetLocalWorkTimeStatsIfExact(bool suppressLogging = false)
		{
			lock (lockObject)
			{
