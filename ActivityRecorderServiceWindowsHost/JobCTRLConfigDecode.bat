...
%SystemRoot%\Microsoft.NET\Framework\v4.0.30319\aspnet_regiis -pdf "appSettings" "%BASEPATH:~0,-1%"
%SystemRoot%\Microsoft.NET\Framework\v4.0.30319\aspnet_regiis -pdf "connectionStrings" "%BASEPATH:~0,-1%"
