...
GO
PRINT N'Altering [dbo].[MobileWorkItems]...';


GO
ALTER TABLE [dbo].[MobileWorkItems]
    ADD [IsBeacon] BIT DEFAULT 0 NOT NULL;
...
AS RETURN 25
GO
PRINT N'Refreshing [dbo].[GetMobileWorkTimeByWorkIdForUser]...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[GetMobileWorkTimeByWorkIdForUser]';
