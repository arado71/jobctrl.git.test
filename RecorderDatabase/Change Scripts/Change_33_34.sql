...
ALTER TABLE [dbo].[ClientSettings]
    ADD [IsGoogleCalendarTrackingEnabled] BIT NULL;


GO
PRINT N'Creating [dbo].[ClientUserCloudEventDates]...';
...
GO
PRINT N'Creating [dbo].[ClientUserCloudEventDates].[IX_ClientUserCloudEventDates_UserId_EventIdHash]...';


GO
CREATE UNIQUE NONCLUSTERED INDEX [IX_ClientUserCloudEventDates_UserId_EventIdHash]
    ON [dbo].[ClientUserCloudEventDates]([UserId] ASC, [EventIdHash] ASC);


GO
PRINT N'Creating [dbo].[ClientUserCloudTokens]...';
...
GO
PRINT N'Creating [dbo].[ClientUserCloudTokens].[IX_ClientUserCloudTokens_UserId]...';


GO
CREATE UNIQUE NONCLUSTERED INDEX [IX_ClientUserCloudTokens_UserId]
    ON [dbo].[ClientUserCloudTokens]([UserId] ASC);
...
ALTER TRIGGER [dbo].[ClientSettings_Versions_U]
	...
	BEGIN
		...
		IF (UPDATE(MenuUpdateInterval) OR UPDATE(CaptureWorkItemInterval) OR UPDATE(CaptureActiveWindowInterval) OR UPDATE(CaptureScreenShotInterval)
			...
			OR UPDATE(IsGoogleCalendarTrackingEnabled))
		BEGIN
...
AS RETURN 34
GO
PRINT N'Creating [dbo].[Client_DeleteCloudToken]...';
...
RETURN 0
GO
PRINT N'Creating [dbo].[Client_GetCloudTokenByUserId]...';
...
RETURN 0
GO
PRINT N'Creating [dbo].[Client_GetCloudTokens]...';
...
RETURN 0
GO
PRINT N'Creating [dbo].[Client_SetCloudToken]...';
...
AS
	...
	RETURN 0
GO
PRINT N'Creating [dbo].[Client_UpdateCloudToken]...';
