...
-- Author: Zoltan Torok
-- =============================================
ALTER PROCEDURE [dbo].[GetTotalWorkTimeByWorkIdForUser]
	(
	@userId int,
...
-- Author: Zoltan Torok
-- =============================================
ALTER PROCEDURE [dbo].[GetWorkTimeByWorkIdForUser]
	(
	@userId int,
	@startDate datetime,
	@endDate datetime,
...
-- Author: Zoltan Torok
-- =============================================
ALTER PROCEDURE [dbo].[GetMobileWorkTimeByWorkIdForUser]
	(
	@userId int,
	@startDate datetime,
	@endDate datetime
...
-- Author: Zoltan Torok
-- =============================================
ALTER PROCEDURE [dbo].[GetIvrWorkTimeByWorkIdForUser]
	(
	@userId int,
	@startDate datetime,
	@endDate datetime,
