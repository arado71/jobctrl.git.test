...
-- Author: Zoltan Torok
-- =============================================
ALTER PROCEDURE [dbo].[GetLearningRuleGenerators]
	(
	@userId int,
...
<ArrayOfRuleGeneratorData xmlns:i="http://www.w3.org/2001/XMLSchema-instance" xmlns="http://jobctrl.com/">
  ...
  <RuleGeneratorData>
    ...
    <Parameters>{"IgnoreCase":true,"ProcessNameParams":[{"MatchingPattern":"^excel[.]exe$","ReplaceGroupName":null}],"TitleParams":[{"MatchingPattern":"^Microsoft Excel(?&lt;optBrac&gt;\\s\\([\\p{L}\\s-]+\\))?\\s-\\s","ReplaceGroupName":null},{"MatchingPattern":"(?&lt;file&gt;.+?)","ReplaceGroupName":"file"},{"MatchingPattern":"(?&lt;optNum&gt;\\s?\\(\\d{1,2}\\)|\\[\\d{1,2}\\])?(?&lt;optExt&gt;\\.\\p{L}{1,4})?(?:[:]\\d+)?(?&lt;optBrac&gt;\\s\\s?\\[[\\p{L}\\s-]+\\])*$","ReplaceGroupName":null}],"UrlParams":[{"MatchingPattern":"^.*$","ReplaceGroupName":null}]}</Parameters>
  </RuleGeneratorData>
  <RuleGeneratorData>
    <Name>ReplaceGroupRuleGenerator</Name>
    <Parameters>{"IgnoreCase":true,"ProcessNameParams":[{"MatchingPattern":"^winword[.]exe$","ReplaceGroupName":null}],"TitleParams":[{"MatchingPattern":"^","ReplaceGroupName":null},{"MatchingPattern":"(?&lt;file&gt;.+?)","ReplaceGroupName":"file"},{"MatchingPattern":"(?&lt;optNum&gt;\\s?\\(\\d{1,2}\\)|\\[\\d{1,2}\\])?(?&lt;optExt&gt;\\.\\p{L}{1,4})?((?&lt;optPar&gt;\\s\\([\\p{L}\\s-]+\\))?(?&lt;optBrac&gt;\\s\\[[\\p{L}\\s-]+\\])?)*(?:[:]\\d+)?\\s- Microsoft Word(?&lt;optParEnd&gt;\\s\\([\\p{L}\\s-]+\\))?$","ReplaceGroupName":null}],"UrlParams":[{"MatchingPattern":"^.*$","ReplaceGroupName":null}]}</Parameters>
  </RuleGeneratorData>
  <RuleGeneratorData>
    <Name>ReplaceGroupRuleGenerator</Name>
