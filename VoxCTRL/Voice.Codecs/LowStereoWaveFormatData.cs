...
{
	public class LowStereoWaveFormatData : WaveFormatData
	{
		public static WaveFormatData Instance = new LowStereoWaveFormatData();

		public override int CodecId { get { return 2; } }
		...
		private LowStereoWaveFormatData()
		{
		}
